...
pub async fn v1_individuals_consents_consent_id_health_fhir_bundle_get(configuration: &configuration::Configuration, consent_id: &str) -> Result<Vec<crate::models::HealthRecord>, Error<V1IndividualsConsentsConsentIdHealthFhirBundleGetError>> {
    let local_var_configuration = configuration;
