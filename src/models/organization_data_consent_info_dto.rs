...
pub struct OrganizationDataConsentInfoDto {
    ...
    #[serde(rename = "consentSentToOrganization", skip_serializing_if = "Option::is_none")]
    pub consent_sent_to_organization: Option<String>,
}

impl OrganizationDataConsentInfoDto {
    pub fn new() -> OrganizationDataConsentInfoDto {
        OrganizationDataConsentInfoDto {
            ...
            consent_sent_to_organization: None,
        }
    }
}
