...
impl CreditCard {
    pub fn new(id: String, name: String, identifier: String, balance: f64, profile: crate::models::CreditCardProfile, summary: crate::models::CreditCardSummary, masked_account_number: String, linked_account_ref: String, version: f32) -> CreditCard {
        CreditCard {
            id,
            name,
            identifier,
