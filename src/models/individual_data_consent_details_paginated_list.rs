...
pub struct IndividualDataConsentDetailsPaginatedList {
    ...
    pub items: Option<Vec<crate::models::IndividualDataConsentDetails>>,
}

impl IndividualDataConsentDetailsPaginatedList {
    pub fn new() -> IndividualDataConsentDetailsPaginatedList {
