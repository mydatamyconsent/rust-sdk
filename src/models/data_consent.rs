...
pub struct DataConsent {
    ...
    pub documents: Option<Vec<crate::models::DataConsentDocument>>,
}

impl DataConsent {
    /// Data Consent details.
    pub fn new(id: String, request_id: String, title: String, description: String, status: crate::models::DataConsentStatus, approved_at_utc: String, data_access_expires_at_utc: String, collectables: Vec<crate::models::CollectibleTypes>) -> DataConsent {
        DataConsent {
            id,
            request_id,
            template_id: None,
