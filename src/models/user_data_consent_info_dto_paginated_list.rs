...
pub struct UserDataConsentInfoDtoPaginatedList {
    ...
    pub items: Option<Vec<crate::models::UserDataConsentInfoDto>>,
}

impl UserDataConsentInfoDtoPaginatedList {
    pub fn new() -> UserDataConsentInfoDtoPaginatedList {
