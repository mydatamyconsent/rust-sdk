...
pub struct OrganizationDataConsentDocument {
...
impl OrganizationDataConsentDocument {
    /// Organization data consent document details.
    pub fn new(approver: String, id: String, consent_id: String, name: String, identifier: String) -> OrganizationDataConsentDocument {
