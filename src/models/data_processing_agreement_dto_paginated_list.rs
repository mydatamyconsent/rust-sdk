...
pub struct DataProcessingAgreementDtoPaginatedList {
    ...
    pub items: Option<Vec<crate::models::DataProcessingAgreementDto>>,
}

impl DataProcessingAgreementDtoPaginatedList {
    pub fn new() -> DataProcessingAgreementDtoPaginatedList {
