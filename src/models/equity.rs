...
impl Equity {
    pub fn new(id: String, name: String, identifier: String, balance: f64, profile: crate::models::Profile, summary: crate::models::EquitySummary, masked_account_number: String, linked_account_ref: String, version: f32) -> Equity {
        Equity {
            id,
            name,
            identifier,
