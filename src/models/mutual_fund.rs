...
impl MutualFund {
    pub fn new(id: String, name: String, investment_value: f64, current_value: f64, currency_code: String, fund_name: String, isin: String, folio_number: String, units: f64, holder: crate::models::Holder, transactions: bool) -> MutualFund {
        MutualFund {
            id,
            name,
            investment_value,
