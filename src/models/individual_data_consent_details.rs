...
pub struct IndividualDataConsentDetails {
...
impl IndividualDataConsentDetails {
    /// Individual data consent details.
    pub fn new(approver: String, id: String, title: String, description: String, status: crate::models::DataConsentStatus, approved_at_utc: String, data_access_expires_at_utc: String) -> IndividualDataConsentDetails {
