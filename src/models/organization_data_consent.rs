...
pub struct OrganizationDataConsent {
...
impl OrganizationDataConsent {
    /// Organization data consent details.
    pub fn new(approver: String, id: String, title: String, description: String, status: crate::models::DataConsentStatus, approved_at_utc: String, data_access_expires_at_utc: String) -> OrganizationDataConsent {
