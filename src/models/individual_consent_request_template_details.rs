...
pub struct IndividualConsentRequestTemplateDetails {
    ...
    pub medical_records: Option<Vec<crate::models::MedicalRecordField>>,
...
impl IndividualConsentRequestTemplateDetails {
    /// IndividualConsentRequestTemplateDetails :  Individual consent request template details.
    pub fn new(id: String, title: String, description: String, short_id: String, status: crate::models::ConsentRequestTemplateStatus, created_by: String, created_at_utc: String) -> IndividualConsentRequestTemplateDetails {
