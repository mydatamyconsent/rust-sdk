...
pub struct MutualFundTransaction {
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "amc")]
    pub amc: String,
...
impl MutualFundTransaction {
    pub fn new(id: String, amc: String, registrar: String, scheme_code: String, scheme_plan: crate::models::MutualFundSchemePlan, isin: String, amfi_code: String, fund_type: crate::models::MutualFundFundType, scheme_option: crate::models::MutualFundSchemeOption, scheme_types: crate::models::MutualFundSchemeType, scheme_category: crate::models::MutualFundSchemeCategory, ucc: String, amount: String, closing_units: String, lien_units: String, nav: String, nav_date: String, r#type: crate::models::MutualFundTransactionType, order_date: String, execution_date: String, lockin_flag: String, lockin_days: String, mode: crate::models::MutualFundHoldingMode, narration: String) -> MutualFundTransaction {
