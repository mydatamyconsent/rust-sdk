...
impl ConsentRequestReceiver {
    pub fn new(country_iso2_code: String, identifiers: Vec<crate::models::KeyValuePair>, identification_strategy: crate::models::IdentificationStrategy) -> ConsentRequestReceiver {
