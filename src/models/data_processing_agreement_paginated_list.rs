...
pub struct DataProcessingAgreementPaginatedList {
    ...
    pub items: Option<Vec<crate::models::DataProcessingAgreement>>,
}

impl DataProcessingAgreementPaginatedList {
    pub fn new() -> DataProcessingAgreementPaginatedList {
