...
pub struct OrganizationConsentRequestDetails {
...
impl OrganizationConsentRequestDetails {
    /// OrganizationConsentRequestDetails : Organization consent request details.
    pub fn new(receiver: String, id: String, title: String, description: String, status: crate::models::DataConsentStatus, created_at_utc: String, expires_at_utc: String) -> OrganizationConsentRequestDetails {
