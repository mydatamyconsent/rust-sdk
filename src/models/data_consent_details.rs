...
impl DataConsentDetails {
    ...
    pub fn new(id: String, title: String, description: String, status: crate::models::DataConsentStatus, approved_at_utc: String, data_access_expires_at_utc: String) -> DataConsentDetails {
        DataConsentDetails {
            id,
            template_id: None,
            title,
