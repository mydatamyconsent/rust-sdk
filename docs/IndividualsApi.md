...
> crate::models::PaginatedListOfFinancialAccountTransactions v1_individuals_consents_consent_id_financial_accounts_account_id_transactions_get(consent_id, account_id, filters, from_date_time, to_date_time, page_no, page_size)
